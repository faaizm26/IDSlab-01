...
NA stands for "not applicable" and the reason that I am getting this as the answer is because there are some observations that do not have data for the visitors variable. 
...
na.rm removes the NA values from the data set.
...
It tells us the data is negatively skewed.
